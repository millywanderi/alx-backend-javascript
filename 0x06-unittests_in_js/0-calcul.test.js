...
describe('calculateNumber', () => {
  it('should return sum of integers', () => {
    assert.strictEqual(claculateNumber(1, 3), 4);
    assert.strictEqual(claculateNumber(1, -1), 0);
    assert.strictEqual(claculateNumber(1, -3), -2);
  });

  it('should round floats', () => {
    assert.strictEqual(claculateNumber(1, 3.7), 5);
    assert.strictEqual(claculateNumber(1.2, 3.7), 5);
    assert.strictEqual(claculateNumber(1.5, 3.7), 6);
    assert.strictEqual(claculateNumber(0.1, 0), 0);
    assert.strictEqual(claculateNumber(1.4, -4.5), -3);
  });
